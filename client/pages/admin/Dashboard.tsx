...
export default function AdminDashboard() {
  ...
  const cards = useMemo(()=>{
    ...
    const avgResDaysCard = { label: 'Avg resolution time', value: Math.round((avgResHours/24)*10)/10, trend: 0, goodIfIncrease: false, details: 'Fastest vs slowest departments vary by day.' };
